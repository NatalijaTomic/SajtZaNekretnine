      ...
      <div class="container">
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-9 text-center mt-5">
            <h1 class="heading" data-aos="fade-up">O nama</h1>
    ...
    <div class="section">
      <div class="container">
        <div class="row text-left mb-5">
          <div class="col-12">
            <h2 class="font-weight-bold heading text-primary mb-4">O nama</h2>
          </div>
          <div class="col-lg-6">
            ...
            <p class="text-black-50">
            Od Januara 2015. godine Dream Team postaje članica Hilton grupe, lidera u svetu nekretnina.
            </p>
            <p class="text-black-50">
          ...
          <div class="col-lg-4">
            <div class="d-flex feature-h">
              ...
              <div class="feature-text">
                <h3 class="heading">Kvalitetne nekretnine</h3>
                <p class="text-black-50">
            ...
            <div class="d-flex feature-h">
              ...
              <div class="feature-text">
                <h3 class="heading">Najbolje rangirani agenti</h3>
                <p class="text-black-50">
            ...
            <div class="d-flex feature-h">
              ...
              <div class="feature-text">
                <h3 class="heading">Lako i bezbedno</h3>
                <p class="text-black-50">
        ...
        <div class="testimonial-slider-wrap">
          ...
          <div class="item">
              <div class="testimonial">
                <img
                  src="images/ContactsMihajlo.jpeg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <h3 class="h5 text-primary">Mihajlo Ogrizović</h3>
                <p class="text-black-50">Vlasnik agencije, agent sa licencom</p>
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  ...
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <h3 class="h5 text-primary">Natalija Tomić</h3>
                <p class="text-black-50">Agent sa licencom</p>
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  ...
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <h3 class="h5 text-primary">Danijela Todić</h3>
                <p class="text-black-50">Agent sa licencom</p>
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  ...
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <h3 class="h5 text-primary">Milica Stojković</h3>
                <p class="text-black-50">Agent sa licencom</p>
                Dream Team nekretnine - Vaš prvi izbor
                <p>
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="images/ContactsIvan.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <h3 class="h5 text-primary">Ivan Stanisavljević</h3>
                <p class="text-black-50">Agent sa licencom</p>
                Dream Team nekretnine - Vaš prvi izbor
                <p>
            ...
            <div class="item">
              <div class="testimonial">
                <img
                  src="images/ContactsVladimir.jpg"
                  alt="Image"
                  class="img-fluid rounded-circle w-25 mb-4"
                />
                <h3 class="h5 text-primary">Vladimir Mitrašinović</h3>
                <p class="text-black-50">Agent sa licencom</p>
                Dream Team nekretnine - Vaš prvi izbor
                <p>
